...
<template>
  <section class="pt-36 pb-64 md:pt-64 md:pb-72 lg:pb-64 xl:pb-72 bg-herobg bg-cover bg-top relative overflow-hidden" id="hero">
      ...
      <div class="container mx-auto px-4 lg:px-10 ">
        ...
        <!-- TEXTS -->
          <div v-motion-slide-visible-once-left class="w-full md:w-1/2 flex flex-col items-center justify-center md:items-start ">
            ...
            <p class="text-black mb-6 text-center font-hind text-lg xl:text-xl xl:leading-loose leading-relaxed lg:leading-9 md:text-start">
      ...
      <div class=" hidden lg:block absolute inset-0 pointer-events-none overflow-hidden z-0">
        <div class="absolute right-0 animate-slide z-0">
